...
import com.Meryem.shopping.Model.Cart;
import com.Meryem.shopping.Prevalent.CartViewHolder;
...
public class CartActivity extends AppCompatActivity{
    // l class eli customer ynajem y3adi order w ychouf l status mta3 l order w ynajem ycancel l order
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtTotalAmount.setText("Total Price = dt."+String.valueOf(overTotalPrice));
